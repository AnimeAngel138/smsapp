        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <h3 class="text-dark mb-4">Grade 1</h3>
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item"><a class="nav-link active" href="#"><i
                                            class="fa fa-list"></i>&nbsp;Section list</a></li>
                        ...
                        <div class="card-body">
                            <!-- Start: Split Button Primary --><a class="btn btn-primary btn-icon-split" role="button"
                                style="margin-right: 6px;"><span class="text-white-50 icon"><i
                                        class="fas fa-align-justify"></i></span><span
                                    class="text-white text">View</span></a><!-- End: Split Button Primary -->
                            <!-- Start: Split Button Info --><a class="btn btn-info btn-icon-split" role="button"><span
                                    class="text-white-50 icon"><i class="fas fa-th-large"></i></span><span
                                    class="text-white text">Grid</span></a><!-- End: Split Button Info -->
                            <div class="row">
                                <div class="col">
                                    <h1>Smart Section</h1>
                                    <p>Paragraph</p>
