                                ...
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                        <h6 class="dropdown-header">alerts center</h6><a
                                            ...
                                            <div><span class="small text-gray-500">MARCH 25 TO APRIL 3O</span>
                                                <p>A Registration start for any type of enrollees!</p>
                                            </div>
                                            ...
                                            <div><span class="small text-gray-500">System Update</span>
                                                <p>The developer will update the system!</p>
                                            </div>
                                        </a><a class="dropdown-item d-flex align-items-center" href="#">
                                            <div class="me-3">
                                            ...
                                            <div><span class="small text-gray-500">May 21, 2022</span>
                                                <p>Learners Alert: Learner #457 in your section needs to be updated</p>
                                            </div>
